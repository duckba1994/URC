...
public class PopupDetailFragment extends DialogFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.popup_window, container, false);
...
//        myMsg.setTextSize(20);
        ...
        btnOK.setOnClickListener(PopupDetailFragment.this);
        return root;
    }
